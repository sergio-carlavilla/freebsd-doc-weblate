...
[NOTE]
====
Desde de 2010, la siguiente sección está desactualizada. Las donaciones de los últimos años aparecen link:https://www.FreeBSD.org/donations/donors.html[aquí].
====

¡El Proyecto FreeBSD está en deuda con los siguientes donantes y me gustaría agradecerles públicamente aquí!

* _Colaboradores del servidor central del proyecto:_
+ 
Las siguientes personas y organizaciones permitieron que el proyecto FreeBSD construyera un nuevo servidor central, que reemplazó a `freefall.FreeBSD.org` en algún momento mediante la donación de los siguientes elementos:

** Ade Barkah mailto:mbarkah@FreeBSD.org[mbarkah@FreeBSD.org] y su empresa, http://www.hemi.com/[ Hemisphere Online], donaron un procesador _Pentium Pro (P6) 200MHz CPU_
** http://www.asacomputers.com/[ASA Computers] donó una _placa base Tyan 1662_.
** Joe McGuckin mailto:joe@via.net[joe@via.net] de http://www.via.net/[ViaNet Communications] donó un _controlador ethernet Kingston._
** Jack O'Neill mailto:jack@diamond.xtalwind.net[jack@diamond.xtalwind.net] donó una _tarjeta SCSI NCR 53C875_.
** Ulf Zimmermann mailto:ulf@Alameda.net[ulf@Alameda.net] of http://www.Alameda.net/[Alameda Networks] donated _128MB of memory_, a _Unidad de disco de 4 Gb y la carcasa._
...
** http://www.cdrom.co.jp/[Laser5] de Japón (una parte de las ganancias de las ventas de sus diversos CDROMs de FreeBSD).
** http://www.mmjp.or.jp/fuki/[Fuki Shuppan Publishing Co.] ha donado una parte de sus ganancias de _Hajimete no FreeBSD_ (FreeBSD, primeros pasos) a los proyectos FreeBSD y XFree86.
** http://www.ascii.co.jp/[ASCII Corp.] donó una parte de sus ganancias de varios libros relacionados con FreeBSD al proyecto FreeBSD.
** http://www.yokogawa.co.jp/[Yokogawa Electric Corp] ha donado generosamente fondos significativos al proyecto FreeBSD.
** http://www.buffnet.net/[BuffNET]
** http://www.pacificsolutions.com/[Pacific Solutions]
** http://www.siemens.de/[Siemens AG] a través de Andre Albsmeier mailto:andre.albsmeier@mchp.siemens.de[andre.albsmeier@mchp.siemens.de]
** Chris Silva mailto:ras@interaccess.com[ras@interaccess.com]

* _Colaboradores de hardware:_
+ 
...
** Chuck Robey mailto:chuckr@glue.umd.edu[chuckr@glue.umd.edu] donó su unidad de cinta para realiazar trabajo experimental.
** Larry Altneu mailto:larry@ALR.COM[larry@ALR.COM] y Wilko Bulte mailto:wilko@FreeBSD.org[wilko@FreeBSD.org] donaron unidades tape Wangtek y Archive QIC-02 para mejorar el driver [.filename]#wt#.
** Ernst Winter (http://berklix.org/ewinter/[Deceased]) contribuyó con una unidad floppy de 2,88 MB al proyecto. Con suerte, esto aumentará la presión para reescribir el driver del floppy.
...
** Christoph P. Kukulies mailto:kuku@FreeBSD.org[kuku@FreeBSD.org] donó una unidad de CD-ROM Mitsumi FX120 de 12 velocidades para el desarrollo del driver IDE CDROM.
** Mike Tancsa mailto:mike@sentex.ca[mike@sentex.ca] donó cuatro tarjetas PCI para cajeros automáticos diferentes para ayudar a aumentar el soporte de estas tarjetas, así como para apoyar el esfuerzo de desarrollo de la pila de cajeros automáticos netatm.

* _Contribuyentes especiales:_

** http://www.osd.bsdi.com/[BSDi] (antes CDROM de Walnut Creek) ha donado más de lo que podemos recordar (consulte la sección "Acerca del proyecto FreeBSD" en el link:https://www.FreeBSD.org/doc/es_ES.ISO8859-1/books/handbook/index.html[Handbook de FreeBSD] para obtener más detalles). En particular, nos gustaría agradecerles por el hardware original que se ha utilizado para `freefall.FreeBSD.org`, nuestra máquina de desarrollo principal, y por `thud.FreeBSD.org`, un ordenador para realizar compilaciones y pruebas. También estamos en deuda con ellos por financiar a varios colaboradores a lo largo de los años y proporcionarnos un uso sin restricciones de su conexión T1 a Internet.
** http://www.interface-business.de/[interface business GmbH, Dresden] ha estado apoyado pacientemente a Jörg Wunsch mailto:joerg@FreeBSD.org[joerg@FreeBSD.org] quien a menudo prefería trabajar en FreeBSD al trabajo remunerado, y a menudo solía recurrir a su conexión a Internet EUnet (bastante cara) siempre que su conexión personal era demasiado lenta para trabajar con ella...
...
* Gordon Bergling mailto:gbe@FreeBSD.org[gbe@FreeBSD.org]
...
* Aleksandr Fedorov mailto:afedorov@FreeBSD.org[afedorov@FreeBSD.org]
...
* Rodney W. Grimes mailto:rgrimes@FreeBSD.org[rgrimes@FreeBSD.org]
...
* Rainer Hurling mailto:rhurlin@FreeBSD.org[rhurlin@FreeBSD.org]
...
* Nick O'Brien mailto:nick@FreeBSD.org[nick@FreeBSD.org]
...
* D Scott Phillips mailto:scottph@FreeBSD.org[scottph@FreeBSD.org]
...
* Richard Scheffenegger mailto:rscheff@FreeBSD.org[rscheff@FreeBSD.org]
...
* Hiroki Tagato mailto:tagattie@FreeBSD.org[tagattie@FreeBSD.org]
...
* Robert Wing mailto:rew@FreeBSD.org[rew@FreeBSD.org]
...
_En orden cronológico inverso:_

* Kris Moore mailto:kmoore@FreeBSD.org[kmoore@FreeBSD.org] (2016 - 2020)
* John Baldwin mailto:jhb@FreeBSD.org[jhb@FreeBSD.org] (2002 - 2006, 2010 - 2014, 2016 - 2020)
* Jeff Roberson mailto:jeff@FreeBSD.org[jeff@FreeBSD.org] (2018 - 2020)
* Brooks Davis mailto:brooks@FreeBSD.org[brooks@FreeBSD.org] (2006 - 2012, 2018 - 2020)
* Benedict Reuschling mailto:bcr@FreeBSD.org[bcr@FreeBSD.org] (2016 - 2020)
* Allan Jude mailto:allanjude@FreeBSD.org[allanjude@FreeBSD.org] (2016 - 2020)
...
* Rodney W. Grimes mailto:rgrimes@FreeBSD.org[rgrimes@FreeBSD.org] (1992 - 1995)
...
* Mahdi Mokhtari mailto:mmokhi@FreeBSD.org[mmokhi@FreeBSD.org] (2017 - 2020)
* Akinori MUSHA mailto:knu@FreeBSD.org[knu@FreeBSD.org] (2000 - 2020)
* Carlos J. Puga Medina mailto:cpm@FreeBSD.org[cpm@FreeBSD.org] (2015 - 2020)
* Philippe Audeoud mailto:jadawin@FreeBSD.org[jadawin@FreeBSD.org] (2008 - 2020)
* Matthew Ahrens mailto:mahrens@FreeBSD.org[mahrens@FreeBSD.org] (2016 - 2020)
* Grzegorz Blach mailto:gblach@FreeBSD.org[gblach@FreeBSD.org] (2012 - 2020)
* Lorenzo Salvadore mailto:salvadore@FreeBSD.org[salvadore@FreeBSD.org] (2020)
* Sean Chittenden mailto:seanc@FreeBSD.org[seanc@FreeBSD.org] (2002 - 2020)
* Zach Leslie mailto:zleslie@FreeBSD.org[zleslie@FreeBSD.org] (2017 - 2020)
...
* Remko Lodder mailto:remko@FreeBSD.org[remko@FreeBSD.org] (2004 - 2019)
* Garrett Wollman mailto:wollman@FreeBSD.org[wollman@FreeBSD.org] (1993 - 2020)
* Andrej Zverev mailto:az@FreeBSD.org[az@FreeBSD.org] (2005 - 2019)
* Bruce Evans mailto:bde@FreeBSD.org[bde@FreeBSD.org] (1994 - 2019)
...
* Benno Rice mailto:benno@FreeBSD.org[benno@FreeBSD.org] (2000 - 2018)
...
* Kurt Lidl mailto:lidl@FreeBSD.org[lidl@FreeBSD.org] (2015 - 2019)
...
* Konrad Witaszczyk mailto:def@FreeBSD.org[def@FreeBSD.org] (2016 - 2018)
* Jeb Cramer mailto:jeb@FreeBSD.org[jeb@FreeBSD.org] (2018 - 2018)
...
* Bryan Venteicher mailto:bryanv@FreeBSD.org[bryanv@FreeBSD.org] (2012 - 2018)
...
* Jonathan Anderson mailto:jonathan@FreeBSD.org[jonathan@FreeBSD.org] (2010 - 2017)
...
* Ruslan Ermilov mailto:ru@FreeBSD.org[ru@FreeBSD.org] (1999 - 2017)
* Yoshiro Sanpei MIHIRA mailto:sanpei@FreeBSD.org[sanpei@FreeBSD.org] (2000 - 2017)
* Sepherosa Ziehau mailto:sephe@FreeBSD.org[sephe@FreeBSD.org] (2007 - 2017)
* Stefan Farfeleder mailto:stefanf@FreeBSD.org[stefanf@FreeBSD.org] (2004 - 2017)
* Mike Silbersack mailto:silby@FreeBSD.org[silby@FreeBSD.org] (2001 - 2018)
* Svatopluk Kraus mailto:skra@FreeBSD.org[skra@FreeBSD.org] (2015 - 2018)
...
* David Chisnall mailto:theraven@FreeBSD.org[theraven@FreeBSD.org] (2011 - 2017)
...
* Jared McNeill mailto:jmcneill@FreeBSD.org[jmcneill@FreeBSD.org] (2016 - 2017)
* Robert Millan mailto:rmh@FreeBSD.org[rmh@FreeBSD.org] (2011 - 2017)
* Stephen McConnell mailto:slm@FreeBSD.org[slm@FreeBSD.org] (2014 - 2017)
...
* Achim Leubner mailto:achim@FreeBSD.org[achim@FreeBSD.org] (2013 - 2015)
...
* Qing Li mailto:qingli@FreeBSD.org[qingli@FreeBSD.org] (2005 - 2013)
...
* Sean C. Farley mailto:scf@FreeBSD.org[scf@FreeBSD.org] (2007 - 2012)
...
_En orden cronológico inverso de la fecha aproximada de la muerte:_
...
+ 
El proyecto FreeBSD más conocido de Kurt fue man:blacklistd[8] que bloquea y libera puertos a petición para evitar el abuso del DoS. También ha hecho muchas otras correcciones de errores y mejoras a DTrace, cargadores de arranque y otros bits y piezas de la infraestructura de FreeBSD.
+ 
...
* Alexander Botero-Lowry mailto:alexbl@FreeBSD.org[alexbl@FreeBSD.org] (2006 - 2011; DEP 2012)
+ 
http://www.legacy.com/obituaries/sfgate/obituary.aspx?pid=159801494[Alexander] fue más conocido por ser un importante colaborador con los ports de Python en FreeBSD y miembro fundador de la http://lists.FreeBSD.org/mailman/listinfo/freebsd-python[lista de correo de Python de FreeBSD], así como su trabajo en XMMS2.
* John Birrell mailto:jb@FreeBSD.org[jb@FreeBSD.org] (1997 - 2009; DEP 2009)
+ 
http://hub.opensolaris.org/bin/view/Community+Group+ogb/In+Memoriam[John] hizo grandes contribuciones a FreeBSD, la más conocida fue importar el código man:dtrace[1]. El sentido del humor y la franqueza de John, o bien le irritaban o bien se hacian amigos rápidamente. Hacia el final de su vida, se mudó a una zona rural y estaba tratando de vivir con el menor impacto posible mientras seguía trabajando en el área del alta tecnología.
* Jean-Marc Zucconi mailto:jmz@FreeBSD.org[jmz@FreeBSD.org] (1994 - 2009; DEP 2009)
+ 
http://www.obs-besancon.fr/article.php3?id_article=323[Jean-Marc] fue un astrofísico que hizo importantes contribuciones al modelado de las atmósferas de los planetas y los cometas en http://www.obs-besancon.fr/[l'Observatoire de Besançon] en Besançon, Francia. Mientras estuvo allí, participó en la concepción y construcción del espectrómetro tricanal Vega que estudió al cometa Halley. También contribuyó durante mucho tiempo a FreeBSD.
* Jun-ichiro Itoh mailto:itojun@FreeBSD.org[itojun@FreeBSD.org] (1997 - 2001; DEP 2008)
+ 
...
* Cameron Grant mailto:cg@FreeBSD.org[cg@FreeBSD.org] (1999 - 2005; DEP 2005)
+ 
...
* Alan Eldridge mailto:alane@FreeBSD.org[alane@FreeBSD.org] (2002 - 2003; DEP 2003)
+ 
http://freebsd.kde.org/memoriam/alane.php[Alan] fue uno de los principales colaboradores al grupo KDE en FreeBSD. Además, ha mantenido muchos otros ports difíciles y los cuales consumen mucho tiempo, como autoconf, CUPS, y python. El camino de Alan no fue fácil, pero su pasión por FreeBSD y su dedicación a la excelencia en la programación le valieron muchos amigos.
