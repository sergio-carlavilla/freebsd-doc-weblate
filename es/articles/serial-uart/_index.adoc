...
+
. Next, appropriate entries in [.filename]#/dev# for the devices must be made using the [.filename]#/dev/MAKEDEV# script. This step can be omitted if you are running FreeBSD{nbsp}5.X with a kernel that has man:devfs[5] support compiled in.
+ 
