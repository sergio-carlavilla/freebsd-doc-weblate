...
闰秒是由 link:http://datacenter.iers.org/[IERS] 在 link:http://datacenter.iers.org/web/guest/bulletins/-/somos/5Rgv/product/16[Bulletin C] 上宣布的。

link:https://tools.ietf.org/html/rfc7164#section-3[RFC 7164] 描述了闰秒的标准行为。也可参见 man:time2posix[3] 。
